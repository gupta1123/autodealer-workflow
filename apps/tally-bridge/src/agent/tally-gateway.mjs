...
export class TallyAgentGateway {
  ...
  async workflowVouchers(identity, { workflow, ledgerNames = [], dateFrom, dateTo, afterAlterId = 0, limit = 50, newestFirst = false, signal } = {}) {
