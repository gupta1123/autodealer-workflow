...
export async function POST(
  ...
  try {
    ...
    if (accountId) {
      ...
      if (!accountKey) {
        return jsonWithCors(request, { error: "Select and confirm a Tally bank ledger before posting." }, { status: 400 });
      }
          ...
          .update({
            ...
            processing_meta: {
              ...
              bankLedgerSelection: {
                ...
                mode: normalizeAccountNumber(submittedAccount.accountNumber || importRow.extracted_account_number || "")
