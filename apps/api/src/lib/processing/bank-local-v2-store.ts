...
type Envelope = { jobId: string; commandId: string; identity: Record<string, unknown>; sourceHash: string; contextHash: string; ledgerNames: string[] };
...
export function localBankV2Store(db: Database) {
  ...
  return {
    claim: (e: Envelope) => call('bank_local_v2_claim', { p_job_id: e.jobId, p_command_id: e.commandId,
      p_identity: e.identity, p_source_hash: e.sourceHash, p_context_hash: e.contextHash, p_ledger_count: e.ledgerNames.length }),
