...
Generated at: 2026-08-04T17:45:23.691Z
...
|---|---|---|---|---|
| `close-balaji-root` | close_match [Shree Balaji Steels Pvt Ltd, Shree Balaji Steel Traders, Shree Balaji Traders, Balaji TMT Depot Pune, Balaji TMT Depot Nashik, Shree Balaji Roadlines, Shree Balaji Transport, Balaji Steel Transport Services] | close_match [Shree Balaji Steels Pvt Ltd, Shree Balaji Steel Traders, Shree Balaji Traders, Balaji TMT Depot Pune, Balaji TMT Depot Nashik, Shree Balaji Roadlines, Shree Balaji Transport, Balaji Steel Transport Services] | PASS | Multiple ledgers contain 'Balaji' as the party root, ambiguous without further descriptor. |
| `close-balaji-steel-root` | close_match [Shree Balaji Steels Pvt Ltd, Shree Balaji Steel Traders, Balaji Steel Transport Services] | close_match [Shree Balaji Steels Pvt Ltd, Shree Balaji Steel Traders, Balaji Steel Transport Services] | PASS | Multiple ledgers share 'Balaji Steel' root with different extensions. |
| `close-mahavir-ocr-collision` | close_match [Mahavir Steel Traders, Mahaveer Steel Traders] | close_match [Mahavir Steel Traders, Mahaveer Steel Traders] | PASS | Spelling variants (Mahavir vs Mahaveer) create collision. |
| `close-bharat-root-spelling` | close_match [Bharat Steels, Bharat Steel Corporation, Bharath Steel Suppliers] | close_match [Bharat Steels, Bharat Steel Corporation, Bharath Steel Suppliers] | PASS | Multiple ledgers share 'Bharat Steel' root, including spelling variant Bharath. |
| `close-sahyadri-ocr-collision` | close_match [Sahyadri Steel Distributors, Sahydri Steel Distributors] | close_match [Sahyadri Steel Distributors, Sahydri Steel Distributors] | PASS | Spelling variants (Sahyadri vs Sahydri) create collision. |
| `close-jsw-root` | close_match [JSW Steel Limited, JSW Steel Coated Products Limited] | close_match [JSW Steel Limited, JSW Steel Coated Products Limited] | PASS | Multiple ledgers share 'JSW Steel' root with different extensions. |
| `close-tata-steel-root` | close_match [Tata Steel Limited, Tata Steel Downstream Products Limited] | close_match [Tata Steel Limited, Tata Steel Downstream Products Limited] | PASS | Ambiguous: 'TATA STEEL' could refer to either Tata Steel Limited or Tata Steel Downstream Products Limited. |
| `close-shakti-root-cross-group` | close_match [Shakti TMT Dealers, Shakti Scrap Traders, Shakti Sponge Iron Suppliers, Shakti Ferro Alloys] | close_match [Shakti TMT Dealers, Shakti Scrap Traders, Shakti Sponge Iron Suppliers, Shakti Ferro Alloys] | PASS | Ambiguous: 'SHAKTI' matches multiple Shakti ledgers. |
| `close-om-root` | close_match [Om Engineering Works, Om Fabricators, Om Electricals] | close_match [Om Engineering Works, Om Fabricators, Om Electricals] | PASS | Ambiguous: 'OM' could refer to Om Engineering Works, Om Fabricators, or Om Electricals. |
| `close-manibhadra-ocr` | close_match [Manibhadra Steel Cement Co, Manibhaddar Steel And Cement Company] | close_match [Manibhadra Steel Cement Co, Manibhaddar Steel And Cement Company] | PASS | Ambiguous: 'MANIBHADRA STEEL CEMENT' matches both Manibhadra Steel Cement Co and Manibhaddar Steel And Cement Company (spelling variant). |
| `close-gst-generic` | close_match [GST Payable, CGST Payable, SGST Payable, IGST Payable] | close_match [GST Payable, CGST Payable, SGST Payable, IGST Payable] | PASS | Generic GST payment; cannot determine specific GST payable ledger. |
| `close-tds-generic` | close_match [TDS Payable 194C, TDS Payable 194Q] | close_match [TDS Payable 194C, TDS Payable 194Q] | PASS | Generic TDS payment with challan 281; cannot determine TDS section. |
| `close-hdfc-transfer-no-account` | close_match [HDFC Bank Current Account 1234, HDFC Bank OD Account 7788] | close_match [HDFC Bank Current Account 1234, HDFC Bank OD Account 7788] | PASS | Internal transfer to HDFC Bank but account not specified; multiple HDFC ledgers exist |
| `suspense-generic-fuel` | suspense | suspense | PASS | Generic fuel payment for plant without explicit fuel type or merchant |
| `suspense-reversal-balaji` | suspense | suspense | PASS | Reversal with ambiguous root 'Balaji'; cannot identify original party |
| `suspense-cheque-return-ambiguous` | suspense | suspense | PASS | Cheque return with ambiguous root 'Ganesh Steel'; cannot identify original party |
| `bias-hallucinated-counterparty` | suspense | suspense | PASS | Raw description contains only NEFT REF number, no identifiable party |
| `bias-conflict-roadlines-vs-steels` | close_match [Shree Balaji Roadlines, Shree Balaji Steels Pvt Ltd] | close_match [Shree Balaji Roadlines, Shree Balaji Steels Pvt Ltd] | PASS | Conflict: raw description says Shree Balaji Roadlines, counterpartyName says Shree Balaji Steels Pvt Ltd |
| `bias-conflict-scrap-vs-sponge` | close_match [Shakti Scrap Traders, Shakti Sponge Iron Suppliers] | close_match [Shakti Scrap Traders, Shakti Sponge Iron Suppliers] | PASS | Raw description states 'SHAKTI SCRAP TRADERS' while derived counterpartyName states 'Shakti Sponge Iron Suppliers' (both exist), creating a conflict that requires close_match. |
| `bias-multiple-derived-fields-not-independent` | suspense | suspense | PASS | Raw description contains only bank reference (NEFT REF 8821001) with no identifiable party or purpose. |
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "Multiple ledgers contain 'Balaji' as the party root, ambiguous without further descriptor."
    },
    {
      "index": 1,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Multiple ledgers share 'Balaji Steel' root with different extensions."
    },
    {
      "index": 2,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Spelling variants (Mahavir vs Mahaveer) create collision."
    },
    {
      "index": 3,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Multiple ledgers share 'Bharat Steel' root, including spelling variant Bharath."
    },
    {
      "index": 4,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Spelling variants (Sahyadri vs Sahydri) create collision."
    },
    {
      "index": 5,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Multiple ledgers share 'JSW Steel' root with different extensions."
    }
  ]
}
```
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "Ambiguous: 'TATA STEEL' could refer to either Tata Steel Limited or Tata Steel Downstream Products Limited."
    },
    {
      "index": 1,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Ambiguous: 'SHAKTI' matches multiple Shakti ledgers."
    },
    {
      "index": 2,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Ambiguous: 'OM' could refer to Om Engineering Works, Om Fabricators, or Om Electricals."
    },
    {
      "index": 3,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Ambiguous: 'MANIBHADRA STEEL CEMENT' matches both Manibhadra Steel Cement Co and Manibhaddar Steel And Cement Company (spelling variant)."
    },
    {
      "index": 4,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Generic GST payment; cannot determine specific GST payable ledger."
    },
    {
      "index": 5,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Generic TDS payment with challan 281; cannot determine TDS section."
    }
  ]
}
```
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "Internal transfer to HDFC Bank but account not specified; multiple HDFC ledgers exist"
    },
    {
      "index": 1,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Generic fuel payment for plant without explicit fuel type or merchant"
    },
    {
      "index": 2,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Reversal with ambiguous root 'Balaji'; cannot identify original party"
    },
    {
      "index": 3,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Cheque return with ambiguous root 'Ganesh Steel'; cannot identify original party"
    },
    {
      "index": 4,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Raw description contains only NEFT REF number, no identifiable party"
    },
    {
      "index": 5,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Conflict: raw description says Shree Balaji Roadlines, counterpartyName says Shree Balaji Steels Pvt Ltd"
    }
  ]
}
```
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "Raw description states 'SHAKTI SCRAP TRADERS' while derived counterpartyName states 'Shakti Sponge Iron Suppliers' (both exist), creating a conflict that requires close_match."
    },
    {
      "index": 1,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Raw description contains only bank reference (NEFT REF 8821001) with no identifiable party or purpose."
    }
  ]
}
```
