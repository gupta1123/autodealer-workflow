...
Generated at: 2026-07-28T09:30:54.696Z
...
|---|---|---|---|---|
| `manibhadra-ocr-close-match` | close_match [Manibhaddar Steel And Cement Company, Manibhadra Steel Cement Co] | close_match [Manibhadra Steel Cement Co, Manibhaddar Steel And Cement Company] | PASS | Narration says 'MANIBHADRA STEEL CEMENT'. Two ledgers share the same root ('Manibhadra' vs 'Manibhaddar') with the same cement/steel descriptor family. The roots are near OCR/spelling variants, so neither can be selected safely. Close match with both candidates. |
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "bankPartyRoot": "Manibhadra",
      "ledgerPartyRoot": null,
      "rootComparison": "different_root",
      "savedMappingDecision": "not_provided",
      "reason": "Narration says 'MANIBHADRA STEEL CEMENT'. Two ledgers share the same root ('Manibhadra' vs 'Manibhaddar') with the same cement/steel descriptor family. The roots are near OCR/spelling variants, so neither can be selected safely. Close match with both candidates."
    }
  ]
}
```
