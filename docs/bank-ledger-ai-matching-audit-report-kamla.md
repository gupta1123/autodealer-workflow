...
Generated at: 2026-07-28T09:30:04.816Z
...
|---|---|---|---|---|
| `kamla-traders-ocr-close-match` | close_match [Kamla Traders, Kamal Traders] | close_match [Kamal Traders, Kamla Traders, Kamaal Traders, Kamal Trading Co] | FAIL | Narration 'KAMLA TRADERS' matches multiple trading ledgers with similar roots (Kamal, Kamla, Kamaal). Exact text match exists but near OCR/spelling variants prevent direct_match. |
  ...
  "matches": [
    {
      ...
      "reason": "Narration 'KAMLA TRADERS' matches multiple trading ledgers with similar roots (Kamal, Kamla, Kamaal). Exact text match exists but near OCR/spelling variants prevent direct_match."
    }
  ]
}
```
