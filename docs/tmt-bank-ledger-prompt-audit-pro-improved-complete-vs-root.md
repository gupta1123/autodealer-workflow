...
Generated at: 2026-08-04T18:01:22.296Z
...
|---|---|---|---|---|
| `direct-supplier-jsw-full` | direct_match -> JSW Steel Limited | direct_match -> JSW Steel Limited | PASS | Description contains 'JSW STEEL LIMITED' which exactly matches the existing ledger 'JSW Steel Limited'. No collision with 'JSW Steel Coated Products Limited' as the description provides the complete distinct legal name. |
| `direct-supplier-tata-downstream` | direct_match -> Tata Steel Downstream Products Limited | direct_match -> Tata Steel Downstream Products Limited | PASS | Description contains 'TATA STEEL DOWNSTREAM PRODUCTS LTD' which exactly matches the existing ledger 'Tata Steel Downstream Products Limited'. No collision with 'Tata Steel Limited' as the description provides the complete distinct legal name. |
| `close-jsw-root` | close_match [JSW Steel Limited, JSW Steel Coated Products Limited] | close_match [JSW Steel Limited, JSW Steel Coated Products Limited] | PASS | Multiple JSW Steel ledgers exist; narration does not specify which one. |
| `close-tata-steel-root` | close_match [Tata Steel Limited, Tata Steel Downstream Products Limited] | close_match [Tata Steel Limited, Tata Steel Downstream Products Limited] | PASS | Multiple Tata Steel ledgers exist; narration does not specify which one. |
  ...
  "matches": [
    {
      ...
      "candidateLedgerNames": [],
      "confidence": 0.98,
      "reason": "Description contains 'JSW STEEL LIMITED' which exactly matches the existing ledger 'JSW Steel Limited'. No collision with 'JSW Steel Coated Products Limited' as the description provides the complete distinct legal name."
    },
    {
      "index": 1,
      "matchType": "direct_match",
      ...
      "candidateLedgerNames": [],
      "confidence": 0.98,
      "reason": "Description contains 'TATA STEEL DOWNSTREAM PRODUCTS LTD' which exactly matches the existing ledger 'Tata Steel Downstream Products Limited'. No collision with 'Tata Steel Limited' as the description provides the complete distinct legal name."
    }
  ]
}
```
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "Multiple JSW Steel ledgers exist; narration does not specify which one."
    },
    {
      "index": 1,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Multiple Tata Steel ledgers exist; narration does not specify which one."
    }
  ]
}
```
