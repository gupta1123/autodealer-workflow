...
Generated at: 2026-07-28T09:17:58.568Z
...
|---|---|---|---|---|
| `axis-bank-root-close-match` | close_match [Axis Bank WCDL A/c 92108044607205, Axis Bank OD Account] | close_match [Axis Bank WCDL A/c 92108044607205, Axis Bank OD Account] | PASS | Narration mentions only 'Axis Bank' without account subtype or number; two existing Axis Bank ledgers (WCDL and OD) exist, making direct assignment ambiguous. |
  ...
  "matches": [
    {
      ...
      "reason": "Narration mentions only 'Axis Bank' without account subtype or number; two existing Axis Bank ledgers (WCDL and OD) exist, making direct assignment ambiguous."
    }
  ]
}
```
