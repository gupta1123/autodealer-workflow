...
Generated at: 2026-08-04T17:06:07.402Z
...
|---|---|---|---|---|
| `direct-customer-exact` | direct_match -> Shree Balaji Steels Pvt Ltd | direct_match -> Shree Balaji Steels Pvt Ltd | PASS | Exact match with the ledger name and transaction narration. |
  ...
  "matches": [
    {
      ...
      "candidateLedgerNames": [],
      "confidence": 0.98,
      "reason": "Exact match with the ledger name and transaction narration."
    }
  ]
}
```
