...
Generated at: 2026-08-04T17:41:09.898Z
...
| `close-hdfc-transfer-no-account` | close_match [HDFC Bank Current Account 1234, HDFC Bank OD Account 7788] | close_match [HDFC Bank Current Account 1234, HDFC Bank OD Account 7788] | PASS | FUND TRANSFER TO HDFC BANK does not specify account number or type; both HDFC Bank Current Account 1234 and HDFC Bank OD Account 7788 are plausible. |
| `suspense-generic-fuel` | suspense | suspense | PASS | FUEL PAYMENT FOR PLANT is generic; multiple fuel ledgers exist (Diesel Expenses, Furnace Oil Expenses, Power And Fuel) and no specific fuel type is identified. |
| `suspense-reversal-balaji` | suspense | suspense | PASS | REVERSAL NEFT BALAJI is a reversal; BALAJI alone collides with multiple Balaji ledgers and reversal does not identify the original party ledger. |
| `suspense-cheque-return-ambiguous` | suspense | suspense | PASS | CHEQUE RETURN GANESH STEEL is a cheque return; GANESH STEEL collides with Ganesh Steel Pune and Ganesh Steel Nashik, and return does not identify which. |
| `bias-hallucinated-counterparty` | suspense | suspense | PASS | NEFT REF 928377001 contains only a reference number; no party or purpose in raw description. Derived counterpartyName is ignored. |
| `bias-conflict-roadlines-vs-steels` | close_match [Shree Balaji Roadlines, Shree Balaji Steels Pvt Ltd] | direct_match -> Shree Balaji Roadlines | FAIL | NEFT TO SHREE BALAJI ROADLINES LR 811 uniquely matches Shree Balaji Roadlines; no other ledger shares the Roadlines descriptor. |
| `bias-conflict-scrap-vs-sponge` | close_match [Shakti Scrap Traders, Shakti Sponge Iron Suppliers] | direct_match -> Shakti Scrap Traders | FAIL | RTGS SHAKTI SCRAP TRADERS uniquely matches Shakti Scrap Traders; no other Shakti ledger contains Scrap Traders. |
| `bias-multiple-derived-fields-not-independent` | suspense | suspense | PASS | NEFT REF 8821001 contains only a reference number; no party or purpose in raw description. Derived counterpartyName is ignored. |
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "FUND TRANSFER TO HDFC BANK does not specify account number or type; both HDFC Bank Current Account 1234 and HDFC Bank OD Account 7788 are plausible."
    },
    {
      "index": 1,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "FUEL PAYMENT FOR PLANT is generic; multiple fuel ledgers exist (Diesel Expenses, Furnace Oil Expenses, Power And Fuel) and no specific fuel type is identified."
    },
    {
      "index": 2,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "REVERSAL NEFT BALAJI is a reversal; BALAJI alone collides with multiple Balaji ledgers and reversal does not identify the original party ledger."
    },
    {
      "index": 3,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "CHEQUE RETURN GANESH STEEL is a cheque return; GANESH STEEL collides with Ganesh Steel Pune and Ganesh Steel Nashik, and return does not identify which."
    },
    {
      "index": 4,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "NEFT REF 928377001 contains only a reference number; no party or purpose in raw description. Derived counterpartyName is ignored."
    },
    {
      "index": 5,
      ...
      "candidateLedgerNames": [],
      "confidence": 0.95,
      "reason": "NEFT TO SHREE BALAJI ROADLINES LR 811 uniquely matches Shree Balaji Roadlines; no other ledger shares the Roadlines descriptor."
    },
    {
      "index": 6,
      "matchType": "direct_match",
      ...
      "candidateLedgerNames": [],
      "confidence": 0.95,
      "reason": "RTGS SHAKTI SCRAP TRADERS uniquely matches Shakti Scrap Traders; no other Shakti ledger contains Scrap Traders."
    },
    {
      "index": 7,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "NEFT REF 8821001 contains only a reference number; no party or purpose in raw description. Derived counterpartyName is ignored."
    }
  ]
}
```
...
If an identifiable party in the raw description conflicts with counterpartyName and both point to existing ledgers, use close_match with both ledgers. Never choose one side of the conflict.
