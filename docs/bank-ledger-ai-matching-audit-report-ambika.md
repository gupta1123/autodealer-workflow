...
Generated at: 2026-07-28T09:18:24.569Z
...
|---|---|---|---|---|
| `ambika-trad-close-match` | close_match [Ambika Traders Malegaon Baramati Pune, Ambika Trading Co] | close_match [Ambika Traders Malegaon Baramati Pune, Ambika Trading Co] | PASS | Narration has party root 'Ambika' with trading descriptor 'TRAD', but two ledgers share the same root and trading descriptor: 'Ambika Traders Malegaon Baramati Pune' and 'Ambika Trading Co'. Cannot determine which one is correct. |
  ...
  "matches": [
    {
      ...
      "reason": "Narration has party root 'Ambika' with trading descriptor 'TRAD', but two ledgers share the same root and trading descriptor: 'Ambika Traders Malegaon Baramati Pune' and 'Ambika Trading Co'. Cannot determine which one is correct."
    }
  ]
}
```
