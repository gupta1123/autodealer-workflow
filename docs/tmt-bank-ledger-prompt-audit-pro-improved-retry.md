...
Generated at: 2026-08-04T17:54:45.047Z
...
| `close-payroll-bulk` | close_match [Salary Payable, Wages Payable] | close_match [Salary Payable, Wages Payable] | PASS | Description mentions both SALARY and WAGES; both ledgers exist. |
| `suspense-cheque-return-ambiguous` | suspense | suspense | PASS | Cheque return with ambiguous Ganesh Steel; cannot determine Pune or Nashik. |
| `bias-hallucinated-counterparty` | suspense | suspense | PASS | Raw description contains only reference number; no party identifiable. |
| `bias-conflict-roadlines-vs-steels` | close_match [Shree Balaji Roadlines, Shree Balaji Steels Pvt Ltd] | close_match [Shree Balaji Roadlines, Shree Balaji Steels Pvt Ltd] | PASS | Description says Roadlines, counterpartyName says Steels; conflict. |
| `bias-wrong-category-bank-charge` | direct_match -> Om Engineering Works | direct_match -> Om Engineering Works | PASS | Exact match for Om Engineering Works in description. |
| `bias-conflict-scrap-vs-sponge` | close_match [Shakti Scrap Traders, Shakti Sponge Iron Suppliers] | close_match [Shakti Scrap Traders, Shakti Sponge Iron Suppliers] | PASS | Description says Scrap Traders, counterpartyName says Sponge Iron Suppliers; conflict. |
| `bias-wrong-category-transport` | direct_match -> Shree Balaji Steels Pvt Ltd | direct_match -> Shree Balaji Steels Pvt Ltd | PASS | Narration explicitly names Shree Balaji Steels Pvt Ltd, which exactly matches an existing ledger. |
| `bias-bank-name-before-party` | direct_match -> Shree Balaji Steels Pvt Ltd | direct_match -> Shree Balaji Steels Pvt Ltd | PASS | Narration explicitly names Shree Balaji Steels Pvt Ltd, which exactly matches an existing ledger. |
  ...
  "matches": [
    {
      ...
      "confidence": 0,
      "reason": "Description mentions both SALARY and WAGES; both ledgers exist."
    },
    {
      "index": 1,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Cheque return with ambiguous Ganesh Steel; cannot determine Pune or Nashik."
    },
    {
      "index": 2,
      "matchType": "suspense",
      ...
      "candidateLedgerNames": [],
      "confidence": 0,
      "reason": "Raw description contains only reference number; no party identifiable."
    },
    {
      "index": 3,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Description says Roadlines, counterpartyName says Steels; conflict."
    },
    {
      "index": 4,
      "matchType": "direct_match",
      ...
      "candidateLedgerNames": [],
      "confidence": 0.95,
      "reason": "Exact match for Om Engineering Works in description."
    },
    {
      "index": 5,
      "matchType": "close_match",
      ...
      "confidence": 0,
      "reason": "Description says Scrap Traders, counterpartyName says Sponge Iron Suppliers; conflict."
    }
  ]
}
```
  ...
  "matches": [
    {
      ...
      "candidateLedgerNames": [],
      "confidence": 0.98,
      "reason": "Narration explicitly names Shree Balaji Steels Pvt Ltd, which exactly matches an existing ledger."
    },
    {
      "index": 1,
      "matchType": "direct_match",
