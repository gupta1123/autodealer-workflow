...
const serviceDefinitions = [
  ["frontend", "npm run dev --workspace @autodealer/web"],
  ["api", "npm run dev --workspace @autodealer/api"],
...
console.log("Kalika local stack starting: frontend :3000, API :3001, Cash Discount gateway :3002, and worker.");
