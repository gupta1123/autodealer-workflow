...
const ref='TEST-LEAVE-10000-06371-20260907';
...
if(!Number.isFinite(closing)||closing>=-10000)throw Error('Balance is already at or below target; refusing write');
const amount=((Math.round(-closing*100)-1000000)/100).toFixed(2);
console.log('RECEIPT AMOUNT',amount,'TARGET OUTSTANDING',10000);
